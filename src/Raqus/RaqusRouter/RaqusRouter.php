 ...
 * ---------------------------
 *
 * This class is added so calls can be made statically like RaqusRouter::get() making the code look pretty.
...
use Closure;
use Exception;
use Raqus\Exceptions\InvalidArgumentException;
use Raqus\Http\Middleware\BaseCsrfVerifier;
use Raqus\Http\Request;
use Raqus\Http\Response;
use Raqus\Http\Url;
use Raqus\RaqusRouter\ClassLoader\IClassLoader;
use Raqus\RaqusRouter\Exceptions\HttpException;
use Raqus\RaqusRouter\Handlers\CallbackExceptionHandler;
use Raqus\RaqusRouter\Handlers\IEventHandler;
use Raqus\RaqusRouter\Route\IGroupRoute;
use Raqus\RaqusRouter\Route\ILoadableRoute;
use Raqus\RaqusRouter\Route\IPartialGroupRoute;
use Raqus\RaqusRouter\Route\IRoute;
use Raqus\RaqusRouter\Route\RouteController;
use Raqus\RaqusRouter\Route\RouteGroup;
use Raqus\RaqusRouter\Route\RoutePartialGroup;
use Raqus\RaqusRouter\Route\RouteResource;
use Raqus\RaqusRouter\Route\RouteUrl;
